...
const safeText = (value: unknown): value is string => typeof value === "string" && value.trim().length > 0 && new TextEncoder().encode(value).byteLength <= 65_536 && !isSecretLikeMatrixContent(value);
