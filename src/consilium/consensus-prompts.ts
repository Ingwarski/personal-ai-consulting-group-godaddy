...
export function consensusPrompt(role: string, input: ConsiliumRuntimeInput): string {
  ...
  return [
    ...
    review ? [
      ...
      "Return JSON containing body and safety: a complete candidate recommendation in the session language. Synthesize current positions and all unresolved review issues. Include one practical decision, up to three actions with owner/time/evidence, key risk or assumption and a review condition. Do not call it consensus yet. This exact candidate will be reviewed and, only if everyone explicitly agrees, published without a final rewrite." :
