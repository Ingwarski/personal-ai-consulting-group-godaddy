...
import type { FinalRecommendationResult, SessionCloseObserver } from "./final-recommendation.ts";
...
export class ConsiliumSessionLauncher {
  ...
  readonly #beforeClose: SessionCloseObserver | undefined;
  ...
  constructor(input: Readonly<{
    ...
    this.#beforeClose = input.beforeClose;
  }
    ...
    try {
      ...
      const prepared = Object.freeze({
        ...
        consensusRouter: new ConsensusRouter({
          ...
          ...(this.#beforeClose === undefined ? {} : { beforeClose: this.#beforeClose })
        }),
        ...
        finalizer: new CriticGatedFinalizer({
          ...
          critic,
          ...(this.#afterConfirmed === undefined ? {} : { afterConfirmed: this.#afterConfirmed }),
          ...(this.#beforeClose === undefined ? {} : { beforeStop: this.#beforeClose })
        })
      });
