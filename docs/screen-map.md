...
- Робоча мова: `uk`
- owner_invocation_id: `30fd3c76-59d7-430a-b177-ea041a7aec67`
...
- `docs/canonical-terms.md` (`dd4a7ef9ee403f941b649247b14eafff044af717d54fb8731b0d2d26665848d3`): незмінені Matrix-терміни; `Google-вхід Власника`, `Дозволена Google-ідентичність`, `Локальна сесія Власника`, `Subscription OAuth`, `Codex-агенти`, `Claude Code-критик`, `Швидкість консиліуму`, незалежне міркування й `Фактичні налаштування сесії`.
...
| `SG-02` | Моделі провайдерів | Незалежні підтверджені моделі груп `Codex-агенти` й `Claude Code-критик` з точними назвами та версіями; Claude: `Opus → Sonnet → Haiku`, версії сімейства від новіших до старіших | Довільний model slug, спільний вибір або непідтверджена доступність версії | `UC-004`, `FR-040`, `FR-041`, `AC-013`; `UJ: S2–S3` |
...
flowchart LR
    ...
    D -->|"Каталог не готовий; локальна сесія чинна"| CD["SS-38: без збереження й нової консультації"]
...
| `SS-35` | Чинні й стандартні значення завантажені | Рівно `Codex-агенти`, `Claude Code-критик`, `Швидкість консиліуму`; незалежні моделі/міркування з точними підтвердженими версіями. Claude: `Opus → Sonnet → Haiku`, новіші версії сімейства першими. `За замовчуванням моделі` не передає явного effort; зміна одного провайдера не змінює іншого | Зміна → `SS-36`/`SS-37`; reset → `SS-42`; Element або закриття; локальний вихід → `SS-30` | `UC-004`, `FR-040`, `FR-041`, `FR-042`, `FR-043`, `FR-044`, `FR-045`, `AC-013`, `AC-014`, `AC-015` |
| `SS-36` | Dirty valid | Незбережений набір відрізняється від current і пройшов capability validation для обох runtimes; mandatory guards не послаблені | Зберегти → `SS-39`; скасувати → `SS-35`; нова несумісність → `SS-37` | `UC-004`, `FR-040`, `FR-041`, `FR-042`, `FR-043`, `FR-044`, `FR-046`, `NFR-019`, `AC-013`, `AC-014` |
