...
- Версія правил: V1
- Дата: 15.08.2026
- owner_invocation_id: `597af5bd-f584-49ac-9b46-a8a149329f1d`

## Source References

- `docs/product-idea.md`: «Позиціонування», «Основний сценарій», «Досвід живого чату», «Межі V1», «Правила даних і доступу», «Модель використання підписок і витрат», «Стандарт швидкості», «Критерій готовності V1», «Підтверджені рішення» та «Припущення та відкладені рішення».
...
- `docs/canonical-terms.md`: `Власник`, агентські ролі, `Консиліум`, `Дослівний консиліум`, Matrix/data/archive terms, `Облік витрат`, `Subscription OAuth`, `Codex OAuth-стан`, `Claude Code OAuth token`, `Реальна Codex-сесія/тред`, `Fail-closed auth/quota`, `A2A`, `Реєстратор`, `Канонічний порядок`, `Незмінний журнал сесії`, `allowlist`, `room_id` і `owner_mxid`, а також розділи 6–11.
...
- точні моделі Codex і Claude та версія і профіль A2A; auth mode вже зафіксований як subscription OAuth без API/PAYG fallback;
