...
const commit = "ea0860d0b89832a3a603743b898face2035b52a1";
const runId = 34411975888;
const artifactId = 10130411789;
const archiveDigest = "8b193d7d5145dd6566c8c6ddc7b2d82a7765bb25a0d2ebf8015820fa78f08638";
...
const scratch = mkdtempSync(join(tmpdir(), "matrix-tls-release-verified-"));
